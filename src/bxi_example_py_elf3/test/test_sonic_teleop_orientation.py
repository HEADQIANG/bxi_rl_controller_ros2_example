...
class SonicContext:
    ...
    def is_orientation_unsafe(self, _quat):
        ...
        raise AssertionError("sonic_teleop must not apply the global orientation gate")
...
def test_sonic_teleop_does_not_apply_orientation_gate():
    ...
    state._update_gripper = lambda: None
